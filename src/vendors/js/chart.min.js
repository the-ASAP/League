...
!(function (t, e) {
    ...
    function ii(t, e = [""], i = t, s, n = () => t[0]) {
        ...
        return new Proxy(o, {
            ...
            ownKeys: (t) => gi(t),
            set: (t, e, i) => (
                ((t._storage || (t._storage = n()))[e] = i), delete t[e], delete t._keys, !0
            ),
        });
    }
    function si(t, e, i, s) {
    ...
    function Gi(t, e, i) {
        const s = t.canvas,
            n = new MutationObserver((t) => {
                for (const e of t)
                    for (const t of e.removedNodes) if (t === s || t.contains(s)) return i();
            });
        return n.observe(document, { childList: !0, subtree: !0 }), n;
    }
    const Zi = new Map();
            ...
            e &&
                ...
                J(n, (e) => {
                    ...
                    if (o in i && i[o].type === r) l = i[o];
                        ...
                        (l = new (zs.getScale(r))({ id: o, type: r, ctx: this.ctx, chart: this })),
                            (i[l.id] = l);
                    }
                    l.init(n, t);
                }),
    ...
    function xn(t, e, i, s) {
        ...
        return (
            s
                ? ((a = i), (t = bn((t = (n = t) === (o = e) ? a : n === a ? o : n), i, e)))
                : (t = bn(t, e, i)),
            t
        );
    }
        ...
        o.borderWidth &&
            ...
            e.fullCircles &&
                (function (t, e, i) {
                    ...
                    let c;
                    for (
                        i && On(t, e, o + _t), t.beginPath(), t.arc(s, n, h, o + _t, o, !0), c = 0;
                        c < r;
                        ++c
                    )
                        t.stroke();
            ...
            ? (function (t) {
                  ...
                  if (
                      ...
                      return (
                          ...
                          new no({ x: h.x, y: h.y, radius: e.getDistanceFromCenterForValue(c) })
                      );
    ...
    class wo extends Ms {
        ...
        adjustHitBoxes() {
            ...
            if (this.isHorizontal()) {
                ...
                for (const l of e)
                    o !== l.row &&
                        ((o = l.row), (r = n(i, this.left + s, this.right - this.lineWidths[o]))),
                        (l.top += this.top + t + s),
        ...
        _getLegendItemAt(t, e) {
            ...
            if (t >= this.left && t <= this.right && e >= this.top && e <= this.bottom)
                for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
                    if (
                        ((s = n[i]),
                        t >= s.left && t <= s.left + s.width && e >= s.top && e <= s.top + s.height)
                    )
            ...
            for (
                ...
                for (
                    m = s[_],
                        ...
                        a &&
                            b.length &&
                            (this._drawColorBox(e, t, _, f, i), (d = Math.max(c.lineHeight, r))),
                        y = 0,
                        w = b.length;
                    y < w;
                    ++y
    ...
    (qo.id = "logarithmic"),
        (qo.defaults = { ticks: { callback: Ss.formatters.logarithmic, major: { enabled: !0 } } });
    class sa extends Yo {
        constructor(t) {
            super(t),
                (this.xCenter = void 0),
    ...
    function ua(t, e, i) {
        ...
        i
            ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = oe(t, "pos", e)),
              ({ pos: s, time: o } = t[r]),
              ({ pos: n, time: a } = t[l]))
            : (e >= t[r].time && e <= t[l].time && ({ lo: r, hi: l } = oe(t, "time", e)),
              ({ time: s, pos: o } = t[r]),
              ({ time: n, pos: a } = t[l]));
        const h = n - s;
