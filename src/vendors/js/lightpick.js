    ...
    var document = window.document,
        ...
        renderDay = function (opts, date, dummy, extraClass) {
            ...
            if (opts.maxDays && opts.startDate && !opts.endDate) {
                if (
                    date.isSameOrBefore(moment(opts.startDate).subtract(opts.maxDays, "day"), "day")
                ) {
                    day.className.push("is-disabled");
                } else if (
                    date.isSameOrAfter(moment(opts.startDate).add(opts.maxDays, "day"), "day")
                ) {
                    day.className.push("is-disabled");
                }
            }
            ...
            if (opts.repick && (opts.minDays || opts.maxDays) && opts.startDate && opts.endDate) {
                ...
                if (opts.maxDays) {
                    if (
                        ...
                        date.isSameOrAfter(moment(tempStartDate).add(opts.maxDays, "day"), "day")
                    ) {
                        day.className.push("is-disabled");
                    }
                }
